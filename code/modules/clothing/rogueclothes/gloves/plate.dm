...
/obj/item/clothing/gloves/roguetown/plate/paalloy
	...
	desc = "Polished gilbranze mechanisms, meticulously interconnected to shroud splayed hands. 'Mercy' and 'innocence' are concepts paraded by the unenlightened; spill their blood without guilt, so that the world may yet be remade in their image." 
	icon_state = "agauntlets"
	smeltresult = /obj/item/ingot/aaslag
