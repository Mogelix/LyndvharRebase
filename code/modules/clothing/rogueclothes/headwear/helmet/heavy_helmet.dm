...
/obj/item/clothing/head/roguetown/helmet/heavy/paalloy
	...
	desc = "Polished gilbranze plates, pounded to form a visored helmet. They are ambitious, and ambition commands sacrifice; let these sundered legionnaires rise again, to spill the blood of unenlightened fools. A coiled pocket is perched atop the rim, awaiting to be plumed."
	icon_state = "ancientbarbute"
	smeltresult = /obj/item/ingot/aaslag
